const old = (
    <div id="menu" className="bg-slate-700 col-span-3 rounded-lg p-4 ">
        ...
        <>
            ...
            <a href="#" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                ...
                <div>
                    <p className="font-medium group-hover:text-indigo-400 leading-4">{userData.userName}</p>
                    <span className="text-xs text-slate-400">User</span>
                </div>
            </a>
            <a onClick={() => {logout()}} className="text-slate-400 text-sm mb-2" href="/login">Logout</a>
            
        </>
        ) : (
            <a className="text-slate-400 text-sm mb-2" href="/login">Login</a>
        )}
        <hr className="my-2 border-slate-700"></hr>
        <div id="menu" className="flex flex-col space-y-2 my-5">
            <a href="#" className="hover:bg-slate-900 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
        ...
        <p className="text-sm text-center text-slate-500">v1.0.0 | &copy; 2022 Energy Management System</p>
    </div>
)